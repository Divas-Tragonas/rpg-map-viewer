          ...
          {sidebarTab === 'mapa' && (
            <>
              ...
              <PlayersPanel
                ...
                onRemove={removePlayer} onAdjustHp={adjustPlayerHp} onSetHpMax={setPlayerHpMax} onLoadParty={loadParty}
              />
            </>
          )}
          {sidebarTab === 'eines' && (
        ...
        {!bgLoaded && (
          <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 3, pointerEvents: 'none' }}>
            <div style={{ textAlign: 'center', color: C.dim }}>
              ...
              <div style={{ fontSize: 16, marginTop: 12, color: '#fff', fontWeight: 700, letterSpacing: '0.06em' }}>v3.49</div>
            </div>
          </div>
        )}
      </div>
