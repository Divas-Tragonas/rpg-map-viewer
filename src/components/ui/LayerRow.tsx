...
export function LayerRow({ layer, visible, onToggle, locked, color, indent, indent2, draggable: isDrag, active, onReset, onDelete, onSelect, selected }: LayerRowProps) {
