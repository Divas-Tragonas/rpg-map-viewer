...
export const CONDITION_ICONS: Record<string, IconPart[]> = {
  ...
  blinded: [{
    d: FACE +
      ...
      'M186 378C210 326 302 326 326 378C318 342 194 342 186 378Z',
  }],
  ...
  exhaustion: [
    // Esquena corbada, cap cot i braços penjant. Es dibuixa amb TRAÇOS: dues parts
    // traçades del mateix color se superposen sense fer forats, i així es pot
    // compondre qualsevol postura sense barallar-se amb l'evenodd.
    { d: 'M152 132A50 50 0 1 0 252 132A50 50 0 1 0 152 132Z' },
    { d: 'M212 176C252 208 274 258 280 320', w: 52 },
    { d: 'M216 214C196 262 186 306 190 356', w: 34 },
    { d: 'M258 240C284 282 300 318 306 358', w: 34 },
    { d: 'M280 320L250 452', w: 42 },
    { d: 'M280 320L326 448', w: 42 },
    { d: 'M356 96C356 96 396 148 396 170A40 40 0 0 1 316 170C316 148 356 96 356 96Z' },
    { d: 'M436 178C436 178 462 210 462 224A26 26 0 0 1 410 224C410 210 436 178 436 178Z' },
  ],
  ...
  // Mà oberta que agafa.
  grappled: [{
    d: 'M84 336L84 250C84 228 101 211 123 211C145 211 162 228 162 250L162 300L174 300' +
      'L174 190C174 168 191 151 213 151C235 151 252 168 252 190L252 294L264 294' +
      'L264 172C264 150 281 133 303 133C325 133 342 150 342 172L342 298L354 298' +
      'L354 214C354 192 371 175 393 175C415 175 432 192 432 214L432 336' +
      'C432 418 368 480 258 480C148 480 84 418 84 336Z' +
      // Els dits es tanquen: quatre osques on es doblega cada falange.
      'M150 268H434V292H150Z',
  }],
  ...
  petrified: [{
    d: HUMAN +
      ...
      'M60 356L104 340L118 384L76 400Z' +
      'M52 442L88 430L98 462L60 472Z' +
      'M420 372L462 356L474 400L432 414Z' +
      'M424 452L458 442L466 472L430 480Z',
  }],
