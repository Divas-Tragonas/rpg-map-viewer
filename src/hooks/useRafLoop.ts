  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      const fc = {
        ...
        rPointerPos: R.rPointerPos, rMeasure: R.rMeasure, rDrawTool: R.rDrawTool, rSelectedToken: R.rSelectedToken, rMultiSelected: R.rMultiSelected, rTurn: R.rTurn,
        ...
        rWallCursor: R.rWallCursor, rWallVertexHover: R.rWallVertexHover, rWallVertexDrag: R.rWallVertexDrag,
        rHoveredRoomId: R.rHoveredRoomId, roomRevealAnimRef: R.roomRevealAnimRef,
