...
- **Distintiu**: aro **daurat sòlid** al token actiu (`drawActiveTurnRing` a `render/tokens.ts`, a les 3 funcions de tokens) — coherent amb el groc però diferent de l'aro de "ressaltar enemics" i del blau de selecció.
